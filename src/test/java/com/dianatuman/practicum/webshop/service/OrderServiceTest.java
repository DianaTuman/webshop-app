...
//        Item item1 = itemRepository.save(new Item("TestItem1", "ItemDescr", 11.0)).block();
...
//        var item1 = itemRepository.save(new Item("TestItem1", "ItemDescr", 11.0)).block();
//        var item2 = itemRepository.save(new Item("TestItem2", "ItemDescr", 12.0)).block();
//
...
//
//        Object modelOrders = mockMvc.perform(get("/orders"))
//                .andReturn().getModelAndView().getModel().get("orders");
//
//        if (modelOrders instanceof List) {
//            List<OrderDTO> orders = (List<OrderDTO>) modelOrders;
